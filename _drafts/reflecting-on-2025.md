...
excerpt: Time to recap a good year.
date: 2025-01-30
permalink: "/reflecting-on-2025/"
category: other
cover_image:
---
...
Working with both Sunny and Yves has been an absolute joy. Some cool projects I built for them even inspired some [recent]({{site.baseurl}}/aggregate-rspec-expectations/) [posts]({{site.baseurl}}/minimal-decorator-ruby/) [on](/minitest-spec/) [this]({{site.baseurl}}/introduction-to-minitest/) [blog](/more-minitest-spec/).
...
<figure>
  <img class='regular box-shadowed' src="{{ site.baseurl }}/media/2026/01/joel-gascogne.png" alt="a screenshot of a tweet by joel gascogne">
...
If you've made it all the way to the end, thank you for reading words written by a human. You rock! (And do know I have a [RSS feed]({{site.baseurl}}/feed.xml)? Just saying.)
